...
data class PrimitiveRecipe(
    @Expose val ingredients: Set<PrimitiveIngredient>,
    @Expose val outputs: Set<PrimitiveIngredient>,
    @Expose val recipeType: RecipeType,
    @Expose val shouldUseForCraftCost: Boolean = true,
) {
